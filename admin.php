			...
			<form action="<?php if ( !is_multisite() )echo 'options.php#authorization'; ?>" method="post">
				...
				<table class="form-table">
					<tbody>
						...
						<tr valign="top">
							<th scope="row"><label for="AD_Integration_sso_enabled"><?php _e('Enable SSO', 'ad-integration'); ?></label></th>
							<td>
								<input type="checkbox" name="AD_Integration_sso_enabled" id="AD_Integration_sso_enabled"<?php if ($this->_sso_enabled) echo ' checked="checked"' ?> value="1" />
							</td>
						</tr>
					</tbody>
				</table>
